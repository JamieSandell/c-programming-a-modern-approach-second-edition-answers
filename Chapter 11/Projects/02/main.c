...
This function wil find the flight whose departure time is closest to desired_time
(expressed in minutes sinces midnight). It will store the departure and arrival times of this
...
int main(void)
{
    ...
    // output the result
    float departure_time_hours_in_12_hour_format = (float)departure_time / 60;
    ...
    printf("Closest departure time is %d:%.2d ", (int)departure_time_hours_in_12_hour_format, minutes);
    ...
    int arrival_time_hours_in_12_hour_format = arrival_time / 60;
...
void find_closest_flight(int desired_time, int *departure_time, int *arrival_time)
{
    ...
    int absolute_difference = abs(desired_time - departure_time_1_minutes_since_midnight);
    ...
    {
        *departure_time = closest_match_in_minutes_since_midnight_departure_time;
        *arrival_time = closest_match_in_minutes_since_midnight_arrival_time;
        closest_match_found = true;
    }
    if (!closest_match_found)
    {
        absolute_difference = abs(desired_time - departure_time_2_minutes_since_midnight);
        if (absolute_difference == 0)
        {
    ...
    if (!closest_match_found)
    {
        absolute_difference = abs(desired_time - departure_time_3_minutes_since_midnight);
        if (absolute_difference == 0)
        {
    ...
    if (!closest_match_found)
    {
        absolute_difference = abs(desired_time - departure_time_4_minutes_since_midnight);
        if (absolute_difference == 0)
        {
    ...
    if (!closest_match_found)
    {
        absolute_difference = abs(desired_time - departure_time_5_minutes_since_midnight);
        if (absolute_difference == 0)
        {
    ...
    if (!closest_match_found)
    {
        absolute_difference = abs(desired_time - departure_time_6_minutes_since_midnight);
        if (absolute_difference == 0)
        {
    ...
    if (!closest_match_found)
    {
        absolute_difference = abs(desired_time - departure_time_7_minutes_since_midnight);
        if (absolute_difference == 0)
        {
    ...
    if (!closest_match_found)
    {
        absolute_difference = abs(desired_time - departure_time_8_minutes_since_midnight);
        if (absolute_difference == 0)
        {
